...
//	}
	...
	// // check if login is success
	// CustomLoginCheney(driver, "Shula Burger Kendall 02-27-17",
	// "084348-01CBI", "Shula4801");
	// // check the flow to exports
	// // StepsToExportCheney(driver);
	// // rename downloadeds
	// // String CurrentPath = RandomAction.setdownloadDir();
	// // File GFS_OG = RandomAction.getLatestFilefromDir(CurrentPath);
	// SendMailSSL.sendMailAction("Cheney - Offline GP", "Shula Burger
	// Kendall");
	// }
	//
	// @Test(priority = 9)
	...
	// // String CurrentPath = RandomAction.setdownloadDir();
	// // File GFS_OG = RandomAction.getLatestFilefromDir(CurrentPath);
	// SendMailSSL.sendMailAction("Cheney - Offline GP", "Trump International
	// Beach Resort");
	// }
	//
	// @Test(priority = 11)
	...
	// // String CurrentPath = RandomAction.setdownloadDir();
	// // File GFS_OG = RandomAction.getLatestFilefromDir(CurrentPath);
	// SendMailSSL.sendMailAction("Cheney - Offline GP", "Trump National Golf
	// Club");
	// }
	//
	// // @Test(priority = 12)
	...
	// // String CurrentPath = RandomAction.setdownloadDir();
	// // File GFS_OG = RandomAction.getLatestFilefromDir(CurrentPath);
	// SendMailSSL.sendMailAction("Cheney Brothers Inc, Hybrid", "Woodfield
	// Country Club");
	// }
	//
	// @Test(priority = 15)
	...
	// // String CurrentPath = RandomAction.setdownloadDir();
	// // File GFS_OG = RandomAction.getLatestFilefromDir(CurrentPath);
	// SendMailSSL.sendMailAction("Cheney - Offline GP", "Sams Hudson Beach
	// Bar");
	// }
